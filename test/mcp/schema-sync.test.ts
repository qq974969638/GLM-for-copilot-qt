...
describe('package.json mcp.servers schema contract (PR #15 F3)', () => {
	...
	it('reads the MCP servers setting only at application scope', () => {
		// [FORK] Built-in MCP server defaults are in package.json for out-of-box UX
expect(serversSetting.default).toBeDefined();
